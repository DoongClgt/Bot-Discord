...
- Dashboard: nhập Role ID trực tiếp ở tab Cấu hình, mục "Role tự cấp cho thành viên mới", rồi bấm Lưu — bot sẽ tự restart và áp dụng. Tên role được resolve hiển thị ngay dưới ô nhập.
